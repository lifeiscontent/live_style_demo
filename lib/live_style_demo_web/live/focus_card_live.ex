  ...
  def render(assigns) do
    ...
    >
      <div class={css_class([:grid])}>
        <div class={css_class([:focus_card])} tabindex="0">
        ...
        <.card>
          <div style={"padding: #{css_var({Tokens, :space, :"6"})}; display: flex; flex-direction: column; gap: #{css_var({Tokens, :space, :"4"})}"}>
            <div>
    ...
    &#125;
            ...
            <div>
              <.button variant={:secondary} navigate={~p"/color"}>
                Next: Color demo
              </.button>
            </div>
          </div>
