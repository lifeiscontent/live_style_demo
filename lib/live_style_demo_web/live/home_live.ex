      ...
      <section class={style([:features_section])}>
        <div class={style([:features_inner])}>
          <div class={style([:section_header])}>
            ...
            <p class={style([:section_subtitle])}>Everything you need to build beautiful, maintainable UIs</p>
          </div>
      ...
      <section class={style([:code_section])}>
        <div class={style([:code_inner])}>
          <div class={style([:section_header])}>
            ...
            <p class={style([:section_subtitle])}>Familiar patterns that feel right at home in Elixir</p>
          </div>
      ...
      <footer class={style([:footer])}>
        <div class={style([:footer_inner])}>
          <p class={style([:footer_text])}>
            Built with <a href="https://phoenixframework.org" class={style([:footer_link])}>Phoenix</a>
